...
mod ulps_eq_f32_tests {
    ...
    fn check_eq_self(value: f32) {
        for max_ulps in 0..8 {
            check_eq(value, value, 0.0_f32,           max_ulps);
            check_eq(value, value, f32::MIN_POSITIVE, max_ulps);
            check_eq(value, value, f32::MAX,          max_ulps);
            check_eq(value, value, f32::INFINITY,     max_ulps);
        }
    }
...
mod ulps_eq_f64_tests {
    ...
    fn check_eq_self(value: f64) {
        for max_ulps in 0..8 {
            check_eq(value, value, 0.0_f64,           max_ulps);
            check_eq(value, value, f64::MIN_POSITIVE, max_ulps);
            check_eq(value, value, f64::MAX,          max_ulps);
            check_eq(value, value, f64::INFINITY,     max_ulps);
        }
    }
