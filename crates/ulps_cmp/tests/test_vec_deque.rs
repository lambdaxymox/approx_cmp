...
fn test_ne2() {
    ...
    let max_ulps = VecDeque::from([1_u32; 8]);
...
fn test_debug_ulps_diff1() {
    ...
    let ulps_diff = VecDeque::from([Some(0_u32); 8]);
...
fn test_debug_ulps_tolerance() {
    let lhs = VecDeque::from([2.00_f32, 3.25_f32, 4.50_f32, 5.75_f32]);
    let rhs = VecDeque::from([2.50_f32, 3.00_f32, 4.00_f32, 6.00_f32]);
    let max_ulps = VecDeque::from([2_u32, 4_u32, 8_u32, 16_u32]);
...
fn test_debug_ulps_all_tolerance() {
    ...
    let rhs = VecDeque::from([2.50_f32, 3.00_f32, 4.00_f32, 6.00_f32]);
    let max_ulps = 8_u32;
    let tolerance = VecDeque::from([max_ulps; 4]);
...
fn test_ne_empty8() {
    ...
    let max_ulps = VecDeque::from([2_u32; 8]);
