...
fn test_debug_ulps_tolerance() {
    ...
    assert_eq!(lhs.debug_ulps_tolerance(&rhs, &max_ulps), Some(max_ulps));
    assert_eq!(rhs.debug_ulps_tolerance(&lhs, &max_ulps), Some(max_ulps));
}
...
fn test_debug_ulps_all_tolerance() {
    ...
    assert_eq!(lhs.debug_ulps_all_tolerance(&rhs, &max_ulps_all), Some(max_ulps));
    assert_eq!(rhs.debug_ulps_all_tolerance(&lhs, &max_ulps_all), Some(max_ulps));
}
...
fn test_debug_ulps_all_tolerance_none() {
    ...
    assert_eq!(lhs.debug_ulps_all_tolerance(&rhs, &max_ulps_all), Some(max_ulps));
    assert_eq!(lhs.debug_ulps_all_tolerance(&empty_cell, &max_ulps_all), None);
    assert_eq!(empty_cell.debug_ulps_all_tolerance(&rhs, &max_ulps_all), None);
}
