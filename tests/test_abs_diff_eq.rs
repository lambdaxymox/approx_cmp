...
mod abs_diff_array_tests {
    ...
    fn test_basic_eq_array2() {
        assert_abs_diff_eq!([1.0_f64, 1.0_f64], [1.0_f64, 1.0_f64], abs_diff_all <= f64::EPSILON);
    }
    
    #[test]
    fn test_basic_ne_array2() {
        assert_abs_diff_ne!([1.0_f64, 1.0_f64], [2.0_f64, 3.0_f64], abs_diff_all <= f64::EPSILON);
    }
    
    #[test]
    fn test_basic_eq_array3() {
        assert_abs_diff_eq!([1.0_f64, 1.0_f64, 1.0_f64], [1.0_f64, 1.0_f64, 1.0_f64], abs_diff_all <= f64::EPSILON);
    }
    
    #[test]
    fn test_basic_ne_array3() {
        assert_abs_diff_ne!([1.0_f64, 1.0_f64, 1.0_f64], [2.0_f64, 3.0_f64, 4.0_f64], abs_diff_all <= f64::EPSILON);
    }
    
    #[test]
    fn test_basic_eq_array4() {
        assert_abs_diff_eq!([1.0_f64, 1.0_f64, 1.0_f64, 1.0_f64], [1.0_f64, 1.0_f64, 1.0_f64, 1.0_f64], abs_diff_all <= f64::EPSILON);
    }
    
    #[test]
    fn test_basic_ne_array4() {
        assert_abs_diff_ne!([1.0_f64, 1.0_f64, 1.0_f64, 1.0_f64], [2.0_f64, 3.0_f64, 4.0_f64, 5.0_f64], abs_diff_all <= f64::EPSILON);
    }
